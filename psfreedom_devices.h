...
//ojo #include "pl3/shellcode_egghunt.h"

#define MAGIC_NUMBER		0x50, 0x53, 0x46, 0x72, 0x65, 0x65, 0x64, 0x6d
#define RTOC_TABLE		0x80, 0x00, 0x00, 0x00, 0x00, 0x33, 0xe7, 0x20
#define USE_JIG 
#ifdef USE_JIG
//ojo #include "pl3/default_payload_3_41.h"
//ojo #include "pl3/default_payload_3_01.h"
//ojo #include "pl3/default_payload_3_10.h"
//ojo #include "pl3/default_payload_3_15.h"
...
static const u8 port1_device_desc[] = {
...
static const u8 port1_config_desc_prefix[] = {
...
static const u8 port2_device_desc[] = {
  0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x08,
  0xAA, 0xAA, 0xBB, 0xBB, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x01,
};

static const u8 port2_config_desc[] = {
  // config
...
static const u8 port3_device_desc[] = {
  0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x08,
  0xAA, 0xAA, 0x55, 0x55, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x02,
};
...
static const u8 port0_device_desc[] = {
...
static const u8 port4_device_desc[] = {
  0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x08,
  0xAA, 0xAA, 0x55, 0x55, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x03,
};

static const u8 port4_config_desc_1[] = {
  // config
...
static const u8 port4_short_config_desc_2[] = {
  // config
  0x09, 0x02, 0x12, 0x00, 0x01, 0x01, 0x00, 0x80,
};

static const u8 port4_config_desc_2[] = {
  // config
...
// OJO
// static const u8 port4_config_desc_3[] = {
...
static const u8 port4_config_desc_3[] = {
  0x09, 0x02, 0x30, 0x00, 0x01, 0x01, 0x00, 0x80, 0x01, 
  0x09, 0x04, 0x00, 0x00, 0x00, 0xfe, 0x01, 0x02, 0x00, 
  0x3e, 0x21, 0x00, 0x00, 0x00, 0x00, 0xfa, 0xce, 0xb0, 
  0x03, 0xaa, 0xbb, 0xcc, 0xdd, 0x80, 0x00, 0x00, 0x00, 
  0x00, 0x46, 0x50, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 
  0x3d, 0xee, 0x70,
};


static const u8 port5_device_desc[] = {
  0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x08,
  0x4c, 0x05, 0xeb, 0x02, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x01,
};

static const u8 port5_config_desc[] = {
  // config
